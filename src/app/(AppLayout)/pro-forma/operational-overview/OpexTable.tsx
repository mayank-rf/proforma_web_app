    ...
    return (
        <TableContainer component={Paper} sx={{ mt: 3 }}>
            ...
            <Typography variant="body1" sx={{ px: 2, pt: 1, pb: 2 }}>
                In Year 1, the total operating expenses are estimated at ${totalOperatingYear1.toLocaleString("en-US")} (about {(totalOperatingYear1 / year1Sales * 100).toFixed(1)}% of projected sales), with labor accounting for the largest share. By Year 3, expenses are expected to grow to ${totalOperatingYear3.toLocaleString("en-US")} while maintaining a similar expense-to-sales ratio, indicating stable cost management despite growth.
            </Typography>
