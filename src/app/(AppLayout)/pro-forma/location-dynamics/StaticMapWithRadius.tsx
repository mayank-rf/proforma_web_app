...
const StaticMapWithRadius: React.FC<StaticMapWithRadiusProps> = ({ lat, lng, zoom = 12, width = 600, height = 600 }) => {
    ...
    const getCirclePath = (radiusMiles: number) => {
        ...
        return `&path=color:0xFF0000FF|weight:2|fillcolor:0xFF000020|enc:${generateCircleEncodedPath(lat, lng, radiusMeters)}`;
    };
