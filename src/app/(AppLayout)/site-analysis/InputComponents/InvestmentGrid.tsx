...
function InvestmentGrid() {
    ...
    const handleInputChange = (index: number, field: string, value: string) => {
        ...
        newData[index].ownerInvestment =
            (newData[index].totalInvestment * newData[index].ownerPercentage) / 100;

        newData[index].bankDebt =
            (newData[index].totalInvestment * newData[index].bankPercentage) / 100;
